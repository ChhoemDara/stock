        ...
        <div class="col-md-12 col-xs-12">
          <form class="form-inline" action="<?php echo base_url('reports/') ?>" method="POST">
            <div class="form-group">
              ...
              <select class="form-control" name="select_today" id="select_today">
                <?php foreach ($report_today as $key => $value): ?>
                  <option value="<?php echo $value ?>" <?php if($value == $selected_today) { echo "selected"; } ?>><?php echo $value; ?></option>
                <?php endforeach ?>
              </select>
            </div>
        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Total Monthly - Report</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="chart">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Total Paid Store - Report Data</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
